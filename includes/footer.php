<?php
// includes/footer.php - 100% 完整版 (水墨武林风)
$stats_users = 0; 
$stats_guides = 0;
try {
...
?>
    <footer class="site-footer">
        ...
        <div class="footer-bottom">
            ...
            <div class="server-status">
                Sesión: <span style="color:#2e7d32;"><i class="fas fa-check-square"></i> Activa</span> | Servidor: <?php echo date('H:i:s'); ?> | PHP: <?php echo phpversion(); ?>
            </div>
        </div>
    </footer>
    ...
    <style>
    /* 页脚专属美化 CSS */
    .site-footer { background: #0a0a0a; color: #999; padding: 60px 20px 20px; margin-top: 60px; font-size: 0.95em; border-top: 4px solid var(--accent); }
    ...
    .footer-col h3 { color: white; margin-bottom: 25px; font-size: 1.2em; font-weight: bold; padding-bottom: 12px; display: inline-block; position: relative; }
    .footer-col h3::after { content: ''; position: absolute; left: 0; bottom: 0; width: 40%; height: 2px; background: var(--accent); }
    ...
    .footer-col-bio h3.footer-logo::after { display: none; }
    .footer-col p { margin: 10px 0; line-height: 1.6; color: #aaa; }
    
    .footer-stats { display: flex; gap: 18px; margin-top: 20px; color: #777; font-size: 0.9em; }
    .footer-stats span { display: flex; align-items: center; gap: 6px; }
    
    .footer-col ul { list-style: none; padding: 0; margin: 0; }
    .footer-col ul li { margin-bottom: 15px; }
    .footer-col ul a { color: #888; text-decoration: none; transition: 0.3s; display: flex; align-items: center; gap: 10px; }
    .footer-col ul a i { font-size: 1em; color: #444; transition: 0.3s; }
    .footer-col ul a:hover { color: white; transform: translateX(5px); }
    .footer-col ul a:hover i { color: var(--accent); }
    
    .social-links { display: flex; flex-direction: column; gap: 15px; }
    .social-links a { color: #888; text-decoration: none; transition: 0.3s; display: flex; align-items: center; gap: 12px; }
    .social-links a i { font-size: 1.3em; color: #444; transition: 0.3s; }
    .social-links a:hover { color: white; transform: translateX(5px); }
    .social-links a:hover i { color: var(--accent); }
    
    .footer-bottom { text-align: center; padding-top: 30px; color: #666; font-size: 0.9em; }
    .footer-bottom p { margin: 6px 0; }
    .server-status { font-size: 0.85em; background: rgba(255,255,255,0.02); display: inline-block; padding: 10px 25px; border-radius: 25px; margin-top: 20px; border: 1px solid rgba(255,255,255,0.05); }
    </style>
</body>
</html>